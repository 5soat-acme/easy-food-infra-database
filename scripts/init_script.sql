...
BEGIN
    IF NOT EXISTS (
            ...
            WHERE "MigrationId" = '20240112124437_BaseInicialIdentidade'
        ) THEN
...
IX_AspNetUserRoles_RoleId" ON "AspNetUserRoles" ("RoleId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS (
            SELECT 1
            FROM "__EFMigrationsHistory"
            WHERE "MigrationId" = '20231209110911_BaseInicialClientes'
        ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240119154908_BaseInicialProdutos'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240120121326_BaseInicialCupons'
    ) THEN
        CREATE TABLE "Cupons" (
            "Id"                  uuid                     NOT NULL,
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240120123100_BaseInicialEstoques'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240113153837_BaseInicialCarrinho'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240113134414_BaseInicialPedidos'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240113150643_BaseInicialPagamentos'
    ) THEN
...
BEGIN
 ...
 WHERE "MigrationId" = '20240112120823_BaseInicialPreparoEntrega'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240112120823_BaseInicialPreparoEntrega'
    ) THEN
